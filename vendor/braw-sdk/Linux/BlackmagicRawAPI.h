...
BMD_CONST REFIID IID_IBlackmagicRawPipelineDevice                 = /* 5C7B0A9B-CF2C-4AB3-84C1-E1C7902360C8 */ { 0x5C,0x7B,0x0A,0x9B,0xCF,0x2C,0x4A,0xB3,0x84,0xC1,0xE1,0xC7,0x90,0x23,0x60,0xC8 };
...
BMD_CONST REFIID IID_IBlackmagicRawReadJobHints                   = /* 1069F99C-A4E2-415A-91C4-5E0CE0C6AF77 */ { 0x10,0x69,0xF9,0x9C,0xA4,0xE2,0x41,0x5A,0x91,0xC4,0x5E,0x0C,0xE0,0xC6,0xAF,0x77 };
...
BMD_CONST REFIID IID_IBlackmagicRawFrameMultiVideo                = /* 96AE962B-30A4-4904-813D-A9EFFE5953C2 */ { 0x96,0xAE,0x96,0x2B,0x30,0xA4,0x49,0x04,0x81,0x3D,0xA9,0xEF,0xFE,0x59,0x53,0xC2 };
...
BMD_CONST REFIID IID_IBlackmagicRawClipMultiVideo                 = /* C699E3E2-3268-4E08-8037-D5C4A2C5CE52 */ { 0xC6,0x99,0xE3,0xE2,0x32,0x68,0x4E,0x08,0x80,0x37,0xD5,0xC4,0xA2,0xC5,0xCE,0x52 };
BMD_CONST REFIID IID_IBlackmagicRawClipImmersiveVideo             = /* 47D287A7-9148-4659-BFCF-C767A089A200 */ { 0x47,0xD2,0x87,0xA7,0x91,0x48,0x46,0x59,0xBF,0xCF,0xC7,0x67,0xA0,0x89,0xA2,0x00 };
BMD_CONST REFIID IID_IBlackmagicRawClipResolutions                = /* C63C290F-525B-4EBE-AB56-87B010CACE19 */ { 0xC6,0x3C,0x29,0x0F,0x52,0x5B,0x4E,0xBE,0xAB,0x56,0x87,0xB0,0x10,0xCA,0xCE,0x19 };
...
enum _BlackmagicRawVariantType {
    ...
    blackmagicRawVariantTypeFloat64                              = 9
};
...
public:
    ...
    virtual HRESULT OpenClipWithGeometry (/* in */ const char* fileName, /* in */ IBlackmagicRawClipGeometry* geometry, /* out */ IBlackmagicRawClip** clip) = 0;
...
public:
    ...
    virtual HRESULT GetVersion (/* out */ const char** version) = 0;
    virtual HRESULT GetCameraSupportVersion (/* out */ const char** version) = 0;
...
public:
    ...
    virtual HRESULT GetInstructionSet (/* out */ BlackmagicRawInstructionSet* instructionSet) = 0;
    virtual HRESULT SetInstructionSet (/* in */ BlackmagicRawInstructionSet instructionSet) = 0;
    virtual HRESULT GetSizeLimit (/* out */ BlackmagicRawSizeLimit* sizeLimit, /* out */ uint32_t* sizeLimitWidth, /* out */ uint32_t* sizeLimitHeight) = 0;
    virtual HRESULT SetSizeLimit (/* in */ BlackmagicRawSizeLimit sizeLimit, /* in */ uint32_t sizeLimitWidth, /* in */ uint32_t sizeLimitHeight) = 0;
...
public:
    ...
    virtual HRESULT WriteCubeFile (/* in */ const char* fileName) = 0;
...
public:
    ...
    virtual HRESULT GetMetadata (/* in */ const char* key, /* out */ Variant* value) = 0;
    virtual HRESULT SetMetadata (/* in */ const char* key, /* in */ Variant* value) = 0;	// To clear metadata to movie original, set value to NULL. This data is not saved to disk until SaveSideCar() is called
    virtual HRESULT GetCameraType (/* out */ const char** cameraType) = 0;
...
extern "C" {
    ...
    BMD_PUBLIC IBlackmagicRawFactory* CreateBlackmagicRawFactoryInstanceFromPath(/* in */ const char* loadPath);
    BMD_PUBLIC IBlackmagicRawFactory* CreateBlackmagicRawFactoryInstanceFromExeRelativePath(/* in */ const char* loadPath);
